...
const descriptors: CrudRouteDescriptor[] = [
  ...
  },
  {
    ...
    model: Reminder,
    permissions: ADMIN_WRITES,
    queryFields: ["listName", "listExternalId", "completed", "syncStatus"],
    sort: "dueDate",
  },
  {
    path: "/appleCalendars",
    model: AppleCalendar,
    permissions: ADMIN_WRITES,
    queryFields: ["name", "isDefault", "writable"],
    sort: "name",
  },
  {
    path: "/calendarEvents",
    model: CalendarEvent,
    permissions: ADMIN_WRITES,
    queryFields: ["calendarName", "calendarExternalId", "syncStatus", "allDay"],
    sort: "startDate",
  },
  {
    path: "/llmFixtures",
